...
def talker_for_wheel_commands():
    ...
    pub_wheel_command = rospy.Publisher('wheel_command',Int32MultiArray,queue_size=1)
   ...
   # wheel_command_right_msg = Float32()
    ...
    while not rospy.is_shutdown(): 
        ...
        msg.data = [wheel_command_left, wheel_command_right]
        
        # Publish the message. 
        pub_wheel_command.publish(msg)
