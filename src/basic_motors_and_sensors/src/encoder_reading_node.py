...
from std_msgs.msg import Int32MultiArray  # "std_msgs.msg" is from ROS, and Int32 is a ROS message type. 
...
def talker(): 
    ...
    pub_enc = rospy.Publisher('/encoders', Int32MultiArray, queue_size=1)
